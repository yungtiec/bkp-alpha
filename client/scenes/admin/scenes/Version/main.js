...
const onPollInterval = (props, dispatch) => {
  return props.fetchComments(props.match.params.versionId);
};

class AdminVersionPanel extends Component {
  constructor(props) {
    super(props);
    autoBind(this);
  }
  ...
  render() {
    ...
    return (
      <div className="admin-project-document-panel  main-container">
        <Link to="/admin/list/version">back to document list</Link>
        <div className="admin-project-document-panel__content">
          <AdminVersionSidebar />
          <div class="admin-project-document-panel__item-container">
            {commentIds.map(aid => {
