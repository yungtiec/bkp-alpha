...
### Framework for the Establishment of Consumer Tokens

### Version 0.4.0

This document is open for feedback at the BKP website: http://framework.thebpk.com. In order for your comments to be considered for version 1.0 of the framework, please submit them before **August 15, 2018.**
...
*The token should be usable and have the intrinsic characteristics of a consumer token.*
...
- Description of scenarios that may trigger a full or partial reversal of the token sale.Privacy policy.
